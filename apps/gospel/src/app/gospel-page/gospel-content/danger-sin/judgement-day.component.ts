  ...
  template: `<ng-container *ngTemplateOutlet="dayOfJudgement"></ng-container>
    <ng-template #dayOfJudgement>
      ...
      <blog-reference-tooltip [reference]="'Zephaniah 1:15-18'">
        ...
        cities And the high corner towers. I will bring distress on men So that they will walk like the blind, Because
        they have sinned against the LORD; And their blood will be poured out like dust And their flesh like dung.
        Neither their silver nor their gold Will be able to deliver them On the day of the LORD'S wrath; And all the
