...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="heSeesAndHears"></ng-container>
    <ng-template #heSeesAndHears>
      ...
      ways God's ways? As the heavens are higher than the earth, so are God's ways higher than our ways, His thoughts
      higher than our thoughts. What we think can never be, unless we think with the mind of God according to the Word
      of God; we can't even begin to think how He thinks, unless we know His Words which are His thoughts revealed. The
      heart of us is deceitfully wicked - who can understand it? Will it not even trick us saying, "I can understand
      myself"? Our hearts are constantly flattering ourselves; as it says,
      ...
      <blog-reference-tooltip [reference]="'1 Corinthians 4:3-5'">
        ...
        the Lord who judges me. Therefore do not pronounce judgment before the time, before the Lord comes, who will
      ...
      <blog-reference-tooltip [reference]="'Job 34:31-32'">
        I have borne chastisement; I will not offend anymore; Teach me what I do not see; If I have done iniquity, I
      ...
      seven times.” (Psalms 12:6) The LORD declares, "Is not My word like fire? And like a hammer which shatters a
      ...
      <blog-reference-tooltip [reference]="'Hebrews 4:12-13'">
        ...
        his sight, but all are naked and exposed to the eyes of him to whom we must give account.
      </blog-reference-tooltip>
      ...
      are on display; they are put on the big screen! Imagine you're secret thoughts put on facebook, publicised for all
      to see - the things you think, on public display! You're afraid of a camera, which can only see in the light; if
      it's dark, you must first shine a light to capture a shot. A camera can only see the outside of a man - if you
      ...
      place in the depths of the earth, He is there; if we make our homes in the west, even in the east, He is there.
      Does He not fill all things everywhere? Isn't His eyes everywhere? He is Creator of every eye of every beast, of
      ...
      the fear of the Lord, we grasp onto faith by which a righteousness man has life, cleansing our hearts thereby. For
      ...
      living and the dead. The Lord's judgment is not short of being executed today; saying,
      ...
      For God is not partial in judging His own people. He judged the whole world, all nations, in times past with a
      ...
      mind was sinful, how much more their actions? For if the mind governs all the members of the body. So if the mind
      is sinful, then the entire body is also given over to wickedness. Likewise, it is said over and over that the
      kings of Israel, which are the heads of Israel, made Israel to sin (1 Kings 14:16, 1 Kings 15:26, 1 Kings 16:2, 1
      Kings 21:22). For the king is head of Israel and Israel is the body. So if the head is wicked, then so is the
      body. If we were honest with ourselves, we would see that our thoughts are no better than the days of Noah; and it
