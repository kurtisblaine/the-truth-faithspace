...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="theLoveOfWealth"></ng-container>
    <ng-template #theLoveOfWealth>
      ...
      of the wrath of the LORD.” (Ezekiel 7:19) For all silver and gold and costly stones can forgive even a single sin;
      as it says,
      ...
      gives freely to the praise of His glory, and the rich hold fast to riches to the pain of his own flesh, for
      ...
      save now when he is in the realm of the dead?
      <br /><br />
      ...
      towards ourselves? If we give, it is to the benefit of others; if we withhold, it is to the hurt of them; as it
