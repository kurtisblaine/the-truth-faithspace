...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="loveOfWealth"></ng-container>
    <ng-template #loveOfWealth>
      ...
      million? Does he not chase after two? As it says,
      ...
      that which is by nature no god. An idolater bows down and serves a statue, which is merely a created thing; so how
      is it any different than a man who serves money?
      <br /><br />
