...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="workAndToil"></ng-container>
    <ng-template #workAndToil>
      ...
      As it said, "every labor is the result of rivalry", which does not matter in the future; we work for the sake of
      ...
      <blog-reference-tooltip [reference]="'Ecclesiastes 1:13-14'">
        And I set my mind to seek and explore by wisdom concerning all that has been done under heaven. It is a grievous
