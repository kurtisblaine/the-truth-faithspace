  ...
  template: `<ng-container *ngTemplateOutlet="loveOfPleasure"></ng-container>
    <ng-template #loveOfPleasure>
      ...
      <blog-reference-tooltip [reference]="'Ecclesiastes 8:14'">
        There is futility which is done on the earth, that is, there are righteous men to whom it happens according to
        the deeds of the wicked. On the other hand, there are evil men to whom it happens according to the deeds of the
