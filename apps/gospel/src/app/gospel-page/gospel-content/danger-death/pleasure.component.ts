...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="theLoveOfPleasure"></ng-container>
    <ng-template #theLoveOfPleasure>
      ...
      is straight. It is lust which corrupts our given necessities into dissipation and waste: for over-eating is not of
      ...
      with laughter and express joyfulness and run around expressing their happiness, jumping for joy. If these things
      ...
      advertisement image: and does the image ever portray true reality? The artist makes the image better than reality
      by skill, but it is not the true norm. And these images are fantasy, imagination, from one's own mind - and so is
      lust. Lustful desire is not reality; for when something is desired, it is made great in one's mind, but it remains
      the same in reality. On the television screen men can put their imaginations so that you can say, "It must be, for
      I have seen it!" But it is not, it is trickery. It is merely an image someone made in their mind, in their
