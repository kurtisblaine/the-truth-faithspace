...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="clearConscience"></ng-container>
    <ng-template #clearConscience>
      ...
      judgment in the resurrection is for reward. So hold fast!
      ...
      flesh as man sees, for everything that is hidden, God sees; and the hidden parts where no man sees, God sees; God
      sees all things, especially the hidden things; as Christ, preaching faith, said,
      ...
      deeds. And so, keeping ourselves pure before God in watchings and prayer, we bring forth works pleasing to Him,
