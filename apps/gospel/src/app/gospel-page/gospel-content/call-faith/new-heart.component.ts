...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="aNewHeart"></ng-container>
    <ng-template #aNewHeart>
      ...
      linen clothes when they ministered in the tabernacle; so the Holy Spirit is signifying that the work of God is not
      ...
      sickness and did good where-ever He went; the people who received healing were those who had faith in His name.
      They were not healed because of their obedience to the law of Moses or any good work they had done; but rather,
      they were healed because of their faith; as it says,
...
export class NewHeartComponent extends GospelContentBaseComponent {
  override name: string = "aNewHeart";
}
