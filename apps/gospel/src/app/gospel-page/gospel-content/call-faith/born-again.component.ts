...
@Component({
  ...
  template: `<div>
    ...
    <lib-link [link]="baseUrl + '/drawings/draw/john-16'">(See more on John 16)</lib-link>
    <br /><br />
    ...
    <lib-link [link]="baseUrl + '/drawings/draw/born-of-water-and-fire'">(See more on Baptisms)</lib-link>
    <br /><br />
...
export class BornAgainComponent extends GospelContentBaseComponent {
  ...
  public override description: string =
    "You must be born again to enter into the kingdom of heaven; for only the imperishable can inherit the imperishable.";
}
