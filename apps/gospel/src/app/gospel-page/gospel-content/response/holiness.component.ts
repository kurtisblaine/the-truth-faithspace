...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="obedienceToHoliness"></ng-container>
    <ng-template #obedienceToHoliness>
      ...
      meaningless chatter, myths, fables, anything that doesn't tell of the blessed God and Savior. No-one can tell of
      Christ except by the Holy Spirit, which is the spirit of prophecy. The Spirit which is from above is holy, which
