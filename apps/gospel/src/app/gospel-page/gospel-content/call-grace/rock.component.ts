...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="theRockOfSalvation"></ng-container>
    <ng-template #theRockOfSalvation>
      ...
      anything abnormal is spiritual; everything contrary to nature is supernatural, it is from the spirit, whether good
      or bad; the supernatural comes not from the physical, but the spiritual. So by God's grace, the people were not
      ...
      springing up to everlasting life; for our confession of Christ is salvation unto us who believe by the
