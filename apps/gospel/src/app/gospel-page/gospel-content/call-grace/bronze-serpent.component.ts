...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="theBronzeSerpent"></ng-container>
    <ng-template #theBronzeSerpent>
      ...
      that they would be rescued from the sting of death;
      <!-- as it is written: -->
      ...
      Thus by looking upon Christ lifted up on a cross, we are saved - not by His death alone, but by His resurrection
      from the dead. For if Christ remains dead, we would be no better off than mediums who consult the dead, or an
      idolater who worships a dead image; as it says,
      ...
      But we inquire of God through Christ. The Israelites who came in later generations looked upon this image of life
      ...
      Furthermore, God commanded the people not to make an image and worship it; but here, God commanded Moses to make
      an image of a fiery serpent; but the making of an image is not sin, it is only counted as sin if it is worshiped;
      for in the days of Solomon, Solomon made bronze oxen and lions, but the people did not worship them and it was not
      ...
      the visible image of God; however, Christ is not dead. In a similar way, man is created in the image of God, and
      we also are not considered dead; as it says, “God created man in His own image, in the image of God He created
      him; male and female He created them.” (Genesis 1:27) So not all images are dead, only the ones man creates. But
      these testimonies are parables, they are pictures, images in one's mind pointing to Christ. And so, through these
      pictures we may see Christ. These testimonies are not Christ in themselves, but they are only images, pictures,
      parables given about Christ; through these testimonies of Christ, we can see Christ: that is faith; so although
      images are dead, and Christ is the visible image of God, it is through these parables, which are dead, which point
      to Christ, which we have conviction and assurance in the faith, which saves; as Christ often spoke in parables and
      once said,
      ...
      >
      Faith is the conviction of things unseen and the assurance of things hoped for; so don't be led astray by seeking
