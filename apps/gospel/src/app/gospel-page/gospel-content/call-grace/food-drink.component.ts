...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="trueFoodAndTrueDrink"></ng-container>
    <ng-template #trueFoodAndTrueDrink>
      ...
      us. Therefore, abide in God; abide in Him for life, filling up with His Word about His Son, so that through His
      ...
      though it is a honeycomb; however, if the proud empties his soul in humility, God's grace works best in him; a
      humble man is filled up, not with the air of himself, but with the grace of Christ; as the writer of Hebrews says,
      ...
      has given Himself as food. Everyone who eats on earth, eats death; but we who come heaven-ward for food, eat life.
      And He gives to us the righteousness by which we who hunger are truly satisfied; as He says,
      <blog-reference-tooltip [reference]="'Matthew 5:6'" [isJesusWord]="true">
        Blessed are those who hunger and thirst for righteousness, for they shall be satisfied.
      </blog-reference-tooltip>
      And the righteousness of God is contrary to food that cannot satisfy, which says, “All a man's labor is for his
      mouth and yet the appetite is not satisfied.” (Ecclesiastes 6:7) And, "He enlarges his appetite like Sheol, And he
      is like death, never satisfied.” (Habakkuk 2:5) So our appetites are never satisfied, but we are satisfied by
      ...
      holy days prescribed by the law were commanded on set days; and these are all fulfilled in Christ. Christ Jesus
