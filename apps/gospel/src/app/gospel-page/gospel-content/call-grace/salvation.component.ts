...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="eternalSalvation"></ng-container>
    <ng-template #eternalSalvation>
      ...
      presumed, "Something like this has never happened ever-since all the days of our life, ever-since the days of old,
      water has come up from the earth and everything has gone on as it should." However, despite what they believed in
      their hearts, water came from the sky and God released the water from inside the earth to flood all the land, to
      destroy all with the breath of life. However, all who entered in through the door of the ark were saved, which was
      Noah and his family, eight in all, and two of every kind of animal with some extra animals for sacrifice; for
      animals were not afraid of man in those days because they were not killed by man for food. And all these point to
      the present time: for whoever enters in through the Door, that is to say, through Jesus Christ, will be saved from
      the flood of God's wrath which is yet to come, which is coming upon the earth, which is a judgment not of water,
      but of fire; this is why it says, “For this you know with certainty, that no immoral or impure person or covetous
      man, who is an idolater, has an inheritance in the kingdom of Christ and God. Let no one deceive you with empty
      words,
      ...
      unbelieving, but the testimony will save the believing. And then, the righteous will be saved through fire, for
