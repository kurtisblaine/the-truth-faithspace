...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="theSonOfGod"></ng-container>
    <ng-template #theSonOfGod>
      ...
      Pointing to Christ, Abraham offered His son Isaac on the altar to God, which was by God's own command, not that
      this thought came from God, but the enemy planted it; as God says through Jeremiah, the prophet,
      ...
      obedience of one man, comes the blessing to the whole world; and that blessing which was promised is in Christ,
      the Seed to come; and Christ, being one, blesses the whole world by His one act of obedience. Furthermore, when
      Abraham was going to sacrifice his son, God provided another sacrifice in place of his son: a ram caught in the
      thicket; so Abraham received his son back from the dead; as it says,
      ...
      (Micah 6:7) No! But rather God provides the Sacrifice. For Isaac, Abraham's son, submitted to his father's will,
      and by so doing, points to Christ who laid down His life willingly; for no-one took His life from Him, but He laid
      it down as commanded by the Father. And it is not unrighteousness on God's behalf, for Christ was handed over to
      ...
      But Christ died without children, so these offspring mentioned are sons of God after His own likeness, being the
      Son of God Himself; as it says,
      ...
      <blog-link [link]="'https://thelightof.life/drawings/draw/Father&Son'"
        >(See more about the Father and the Son, the Son and the Church)</blog-link
      ><br /><br />
      ...
      ><blog-link [link]="'https://thelightof.life/drawings/draw/slavesvssons'"
...
export class SonComponent extends GospelContentBaseComponent {
  override name: string = "theSonOfGod";
}
