...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="theSonOfGod"></ng-container>
    <ng-template #theSonOfGod>
      ...
      ever crosses His mind. So although the command to offer Isaac on the alter came from God, the thought did not come
      from God; but when Abraham offered His son Isaac on the altar, God used it to test Abraham and point to Christ
      Jesus to come; as God promised,
