...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="theVictor"></ng-container>
    <ng-template #theVictor>
      ...
      called for Samson to make a public spectacle of him since he was their enemy; but Samson prayed to the Lord,
      ...
      likewise the power of satan is in his mouth, namely his lies; but we have been set free by the Truth: Jesus Christ
      crucified. (And in Him there is no condemnation; for if we walk according to the Spirit, we are not under the law,
      but under grace; and under Him and in Him, there is no sin; so while in Him, we are free from the power of sin,
      for where the Spirit of the Lord is there is freedom.) <br /><br />
...
export class VictorComponent extends GospelContentBaseComponent {
  override name: string = "theVictor";
}
