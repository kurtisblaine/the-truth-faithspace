...
@Component({
  ...
  template: `<ng-container *ngTemplateOutlet="theLambOfGod"></ng-container>
    <ng-template #theLambOfGod>
      ...
      the fault never occurred, for it was forgiven - the wrong was offset. The blood does nothing if it's still within
      ...
      sin offering for the whole world, not just the congregation of Israel. But how is one for all? As it is written,
      “These of the sons of Gad were captains of the army; he who was least was equal to a hundred and the greatest to a
      ...
      seen and heard, namely, Jesus is appointed by God to be the Savior of the world; so now, we may have confidence to
      ...
      they sacrifice an offering to You." For,
